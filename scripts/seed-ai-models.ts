...
async function seedAIModels() {
  console.log('🌱 Seeding AI models and interaction types...');
  ...
  const interactionTypes = [
    ...
    },
    {
      ...
      description: 'Generate quiz questions and interactive examples',
    },
    {
      typeName: 'answer_marking',
      displayName: 'Answer Marking',
      description: 'Mark and provide feedback on user answers',
    },
    {
      typeName: 'keyword_extraction',
      displayName: 'Keyword Extraction',
      description: 'Extract keywords from search queries',
    },
    {
    ...
    },
    {
      ...
      description: 'Select and create tags for articles',
    },
    {
      typeName: 'chat',
      displayName: 'Chat/Tutoring',
      description: 'AI chat and tutoring interactions',
    },
  ];
  ...
  console.log('🎉 AI models and interaction types seeded successfully!');
}
